...
`,ge=["dark","light","feyenoord","classic","neon","gold"];function ue(e,t){const a=function(e){const t=e&&"string"==typeof e.skin?e.skin.toLowerCase():"dark";return ge.includes(t)?t:"dark"}(t);return e&&e.setAttribute&&e.setAttribute("data-skin",a),a}const me=(e,t)=>Array.from({length:t-e+1},((t,a)=>e+a)),fe={serie_a:{match:(e,t)=>"ita.1"===e||t.includes("italian_serie_a"),champions:[1,2,3,4],europa:[5],conference:[6],relegation:"bottom3"},premier_league:{match:(e,t)=>"eng.1"===e||t.includes("english_premier"),champions:[1,2,3,4,5],europa:[6],conference:[7],relegation:"bottom3"},laliga:{match:(e,t)=>"esp.1"===e||t.includes("spanish_la_liga")||t.includes("spanish_laliga"),champions:[1,2,3,4],europa:[5],conference:[6],relegation:"bottom3"},bundesliga:{match:(e,t)=>"ger.1"===e||t.includes("german_bundesliga"),champions:[1,2,3,4],europa:[5],conference:[6],relegation:[17,18]},ligue_1:{match:(e,t)=>"fra.1"===e||t.includes("french_ligue_1"),champions:[1,2,3],europa:[4],conference:[5],relegation:[17,18]},eredivisie:{match:(e,t)=>"ned.1"===e||t.includes("dutch_eredivisie"),champions:[1,2],europa:[3],conference:[4,5],relegation:[17,18]},primeira_liga:{match:(e,t)=>"por.1"===e||t.includes("portuguese_primeira"),champions:[1,2],europa:[3],conference:[4],relegation:[17,18]},ucl_league_phase:{match:(e,t)=>"uefa.champions"===e||t.includes("uefa_champions_league"),champions:me(1,8),europa:me(9,24),conference:[],relegation:"bottom12"},uel_league_phase:{match:(e,t)=>"uefa.europa"===e||t.includes("uefa_europa_league"),champions:me(1,8),europa:me(9,24),conference:[],relegation:"bottom12"},uecl_league_phase:{match:(e,t)=>"uefa.europa.conf"===e||t.includes("uefa_conference"),champions:me(1,8),europa:me(9,24),conference:[],relegation:"bottom12"},world_cup:{match:(e,t)=>"fifa.world"===e||t.includes("fifa_world_cup")||t.includes("world_cup"),champions:[1,2],europa:[3],conference:[],relegation:"bottom1",kind:"cup_group",hero:{icon:"🏆",accent:"world_cup"},labels:{champions:"zone.qualified",europa:"zone.third_place_playoff",conference:null,relegation:"zone.eliminated"}},uefa_euro:{match:(e,t)=>"uefa.euro"===e||t.includes("uefa_euro")||t.includes("european_championship"),champions:[1,2],europa:[3],conference:[],relegation:"bottom1",kind:"cup_group",hero:{icon:"⭐",accent:"uefa_euro"},labels:{champions:"zone.qualified",europa:"zone.third_place_playoff",conference:null,relegation:"zone.eliminated"}},copa_america:{match:(e,t)=>"conmebol.america"===e||t.includes("copa_america")||t.includes("conmebol_america"),champions:[1,2],europa:[],conference:[],relegation:"bottom2",kind:"cup_group",hero:{icon:"🏆",accent:"copa_america"},labels:{champions:"zone.qualified",europa:null,conference:null,relegation:"zone.eliminated"}}};customElements.define("calcio-live-classifica",class extends oe{static get properties(){return{hass:{},_config:{},maxTeamsVisible:{type:Number},hideHeader:{type:Boolean},selectedGroup:{type:String},_eventSubscriptions:{type:Array},_toastMessage:{type:String},_toastVisible:{type:Boolean},_toastVariant:{type:String}}}setConfig(e){if(!e.entity)throw new Error("Entity required");this._config=e,ue(this,e),this.maxTeamsVisible=e.max_teams_visible?e.max_teams_visible:10,this.hideHeader=e.hide_header||!1,this.selectedGroup=e.selected_group||"",this.showEventToasts=!0===e.show_event_toasts,this.highlightTeam=(e.highlight_team||e.my_team||"").toLowerCase(),this.showStats=!1!==e.show_stats,this.showGoalsFor=!0===e.show_goals_for,this.compactMode=!0===e.compact_mode,this.compactTop=parseInt(e.compact_top)||5,this.compactBottom=parseInt(e.compact_bottom)||3,this._toastMessage="",this._toastVisible=!1,this._toastVariant="goal",this._toastTimer=null}_t(e,t){return pe(e,de(this.hass,this._config),t)}connectedCallback(){super.connectedCallback(),this._subscribeToEvents()}disconnectedCallback(){super.disconnectedCallback(),this._eventSubscriptions&&Array.isArray(this._eventSubscriptions)&&(this._eventSubscriptions.forEach((e=>{"function"==typeof e&&e()})),this._eventSubscriptions=[])}_subscribeToEvents(){this.hass&&this.hass.connection&&(this._eventSubscriptions=[],["calcio_live_goal","calcio_live_yellow_card","calcio_live_red_card"].forEach((e=>{this.hass.connection.subscribeEvents(this._handleCalcioLiveEvent.bind(this),e).then((e=>{"function"==typeof e&&this._eventSubscriptions.push(e)}))})))}_eventBelongsToThisCard(e){if(!this.hass||!this._config)return!1;const t=this._config.entity||"",a=e.competition_code;if(!a)return!1;const i=a.replace(/\./g,"_").toLowerCase();return t.toLowerCase().includes(i)}_handleCalcioLiveEvent(e){const t=e.event_type,a=e.data;this._eventBelongsToThisCard(a)&&this.showEventToasts&&this._showEventToast(t,a)}_showEventToast(e,t){let a="",i="goal";"calcio_live_goal"===e?(a=`<strong>${this._t("event.goal").toUpperCase()}!</strong> ${t.player} · ${t.home_team} ${t.home_score} - ${t.away_score} ${t.away_team}`,i="goal"):"calcio_live_yellow_card"===e?(a=`🟨 <strong>${this._t("event.yellow_card")}</strong> · ${t.player}${t.minute?` (${t.minute}')`:""}`,i="yellow"):"calcio_live_red_card"===e?(a=`🟥 <strong>${this._t("event.red_card")}</strong> · ${t.player}${t.minute?` (${t.minute}')`:""}`,i="red"):"calcio_live_match_finished"===e&&(a=`<strong>${this._t("status.finished")}!</strong> ${t.home_team} ${t.home_score} - ${t.away_score} ${t.away_team}`,i="finished"),a&&(this._toastMessage=a,this._toastVariant=i,this._toastVisible=!0,this._toastTimer&&clearTimeout(this._toastTimer),this._toastTimer=setTimeout((()=>{this._toastVisible=!1,this.requestUpdate()}),4e3),this.requestUpdate())}getCardSize(){return 5}static getConfigElement(){return document.createElement("calcio-live-classifica-editor")}static getStubConfig(){return{entity:"sensor.calcio_live",max_teams_visible:10,hide_header:!1,selected_group:"",show_event_toasts:!1}}_getZoneConfig(){if(this._config.zone_config)return this._config.zone_config;if(this._config.zone_preset&&fe[this._config.zone_preset])return fe[this._config.zone_preset];return this._inferPresetFromEntity()||{champions:[],europa:[],conference:[],relegation:null}}_getZoneLabels(){const e=this._getZoneConfig().labels||{};return{champions:void 0!==e.champions?e.champions:"zone.champions",europa:void 0!==e.europa?e.europa:"zone.europa",conference:void 0!==e.conference?e.conference:"zone.conference",relegation:void 0!==e.relegation?e.relegation:"zone.relegation"}}_hasZonePositions(e){return!!e&&(Array.isArray(e)?e.length>0:"string"==typeof e&&/^bottom\d+$/.test(e))}_inferPresetFromEntity(){const e=(this._config.entity||"").toLowerCase(),t=this.hass&&this._config.entity?this.hass.states[this._config.entity]:null,a=t&&t.attributes?String(t.attributes.competition_code||"").toLowerCase():"";for(const[,t]of Object.entries(fe))if(t.match&&t.match(a,e))return t;return null}_positionInZone(e,t,a){if(!a)return!1;const i=String(a).match(/^bottom(\d+)$/);if(i){const a=parseInt(i[1],10);return t&&e>t-a}return!!Array.isArray(a)&&a.includes(Number(e))}_translatePhase(e){return e?{"regular-season":this._t("phase.regular_season"),"regular season":this._t("phase.regular_season"),"group-stage":this._t("phase.group_stage"),"group stage":this._t("phase.group_stage"),playoffs:this._t("phase.playoffs")}[String(e).toLowerCase()]||e:""}_shouldShowPhase(e){return!!e&&("regular-season"!==String(e).toLowerCase()&&!/\d{4}/.test(e))}_isCupGroupStage(){const e=this._getZoneConfig();return e&&"cup_group"===e.kind}_groupHasNoMatches(e){if(!e||!e.length)return!1;const t=e=>{if(null==e||""===e)return 0;const t=parseInt(String(e).replace("+",""),10);return isNaN(t)?0:t};return e.every((e=>t(e.wins)+t(e.draws)+t(e.losses)===0))}_zoneClass(e,t){const a=this._getZoneConfig();return this._positionInZone(e,t,a.champions)?1!==e||this._isCupGroupStage()?"zone-cl":"zone-cl rank-first":this._positionInZone(e,t,a.europa)?"zone-el":this._positionInZone(e,t,a.conference)?"zone-conf":this._positionInZone(e,t,a.relegation)?"zone-rel":"zone-default"}_sortStandings(e,t){let a=(e||[]).filter((e=>null!=e.rank));return t.includes("MLS")?(a=a.slice().sort(((e,t)=>t.points!==e.points?t.points-e.points:t.goal_difference!==e.goal_difference?t.goal_difference-e.goal_difference:t.goals_for-e.goals_for)),a.forEach(((e,t)=>{e.rank=t+1}))):a=a.slice().sort(((e,t)=>e.rank-t.rank)),a}_currentGroup(e){return e.find((e=>e.name===this.selectedGroup))||e[0]}render(){if(!this.hass||!this._config)return U``;const e=this._config.entity,t=this.hass.states[e];if(!t)return U`<ha-card class="empty">${this._t("generic.unknown_entity")}: ${e}</ha-card>`;const a=t.attributes.season||"",i=t.attributes.league_abbreviation&&"N/A"!==t.attributes.league_abbreviation?t.attributes.league_abbreviation:null,n=i&&t.attributes.league_name?a.replace(t.attributes.league_name,i).trim():a,s=t.attributes.standings_groups||[],o=!this.selectedGroup&&s.length>1,r=this._currentGroup(s),l=this._sortStandings(r?r.standings:[],n),c=l.length,d=48*Math.min(this.maxTeamsVisible,c)+50,p=this.highlightTeam?(l.find((e=>e.team_name&&e.team_name.toLowerCase().includes(this.highlightTeam)))||{}).rank:null,h=Math.round(l.reduce(((e,t)=>e+(parseInt(t.games_played)||0)),0)/2),g=l.reduce(((e,t)=>e+(parseInt(t.goals_for)||0)),0),u=c>0&&l.every((e=>0===parseInt(e.wins??"0")&&0===parseInt(e.draws??"0")&&0===parseInt(e.losses??"0")));return U`
              ...
              <tr class="${this._zoneClass(e.rank,t)} ${a?"highlighted-team":""}">
                ...
                <td class="team-cell">
                  ...
                  <div class="tname-group">
                    ...
                    ${this.showGoalsFor&&e.goals_for&&parseInt(e.goals_for)>=0?U`<span class="goals-for-hint">⚽ ${e.goals_for}</span>`:""}
                  </div>
                </td>
                <td>${l??"-"}</td>
                <td>${n??"-"}</td>
        ...
        <div class="scroll-content" style="max-height: ${p}px;">
          ${c.map((e=>U`
            <div class="day-divider ${0===e.dayDiff?"today":-1===e.dayDiff?"yesterday":1===e.dayDiff?"tomorrow":""}">
              ${e.key}
              ${null!==e.dayDiff&&e.dayDiff>1?U`<span class="day-rel">· over ${e.dayDiff} d</span>`:""}
            </div>
    ...
    `}updated(e){(e.has("showPopup")||e.has("activeMatch"))&&this.renderPopupToBody()}renderPopupToBody(){if(!this.showPopup||!this.activeMatch){const e=document.getElementById("calcio-live-matches-popup");return void(e&&e.remove())}let e=document.getElementById("calcio-live-matches-popup");e||(e=document.createElement("div"),e.id="calcio-live-matches-popup",e.style.cssText="\n        position: fixed; inset: 0;\n        display: flex; justify-content: center; align-items: center;\n        z-index: 999999;\n        background: rgba(0,0,0,0.7);\n        backdrop-filter: blur(8px);\n        overflow: auto;\n      ",e.addEventListener("click",(t=>{t.target===e&&(this.showPopup=!1)})),document.body.appendChild(e));const t=this.activeMatch,a=e=>this._t(e),i=getComputedStyle(this),n=i.getPropertyValue("--cl-bg").trim()||"#1a1f2e",s=i.getPropertyValue("--cl-text").trim()||"#f8fafc",o=i.getPropertyValue("--cl-text-2").trim()||"#94a3b8",r=i.getPropertyValue("--cl-accent").trim()||"#6366f1",l=i.getPropertyValue("--cl-accent-2").trim()||"#ec4899",c=i.getPropertyValue("--cl-divider").trim()||"rgba(255,255,255,0.08)";e.innerHTML=`\n      <div style="background:${n}; padding:24px; border-radius:20px; width:90%; max-width:560px; max-height:85vh; overflow-y:auto; border:1px solid ${c}; box-shadow:0 24px 64px rgba(0,0,0,0.6); margin:auto; color:${s}; font-family:-apple-system,BlinkMacSystemFont,'SF Pro Display',sans-serif;">\n        <h3 style="margin:0 0 20px; font-size:22px; font-weight:800; letter-spacing:-0.02em; background:linear-gradient(135deg,${r},${l}); -webkit-background-clip:text; background-clip:text; -webkit-text-fill-color:transparent;">${a("popup.match_details")}</h3>\n        <div style="display:flex; justify-content:center; align-items:center; gap:18px; margin-bottom:24px;">\n          <img style="width:64px; height:64px; object-fit:contain;" src="${t.home_logo}" alt="${t.home_team}" />\n          <div style="text-align:center;">\n            <div style="font-size:38px; font-weight:900; letter-spacing:-0.04em; line-height:1;">${t.home_score&&"N/A"!==t.home_score?t.home_score:"-"} <span style="opacity:0.4;">-</span> ${t.away_score&&"N/A"!==t.away_score?t.away_score:"-"}</div>\n            <div style="font-size:12px; color:${o}; margin-top:8px; font-weight:600;">${t.clock&&"N/A"!==t.clock?t.clock:t.status&&"N/A"!==t.status?t.status:""}</div>\n          </div>\n          <img style="width:64px; height:64px; object-fit:contain;" src="${t.away_logo}" alt="${t.away_team}" />\n        </div>\n        <p style="text-align:center; color:${o}; font-size:14px; margin:0 0 20px;"><strong>${t.home_team}</strong> tegen <strong>${t.away_team}</strong></p>\n        <div id="matches-events-container"></div>\n        <button id="popup-close-btn" style="background:linear-gradient(135deg,${r},${l}); color:white; padding:12px 20px; border:none; border-radius:12px; cursor:pointer; margin-top:20px; font-weight:800; width:100%; font-size:14px;">${a("generic.close")}</button>\n      </div>\n    `;const d=e.querySelector("#popup-close-btn");d&&d.addEventListener("click",(()=>{this.showPopup=!1}));const p=e.querySelector("#matches-events-container"),{goals:h,yellowCards:g,redCards:u}=this.separateEvents(t.match_details||[]),m=(e,t,a)=>t.length?`<div style="margin-bottom:14px; padding:14px; background:${a.bg}; border-left:3px solid ${a.border}; border-radius:10px;">\n        <h5 style="margin:0 0 8px; font-size:12px; text-transform:uppercase; letter-spacing:0.08em; color:${a.border}; font-weight:800;">${e}</h5>\n        <ul style="margin:0; padding-left:18px; font-size:13px; color:#cbd5e1;">${t.map((e=>`<li style="margin:4px 0;">${e}</li>`)).join("")}</ul>\n      </div>`:"";let f="";f+=m(a("event.goal"),h,{bg:`rgba(${r.replace("#","")},0.1)`,border:r}),f+=m(a("event.yellow_card"),g,{bg:"rgba(245,158,11,0.1)",border:"#f59e0b"}),f+=m(a("event.red_card"),u,{bg:"rgba(239,68,68,0.1)",border:"#ef4444"}),p.innerHTML=f||`<p style="text-align:center; color:#94a3b8; font-size:13px;">${a("popup.no_events")}</p>`}static get styles(){return[he,s`
      :host {
        --cl-accent: #6366f1;
        --cl-accent-2: #ec4899;
        --cl-live: #ef4444;
    ...
    `}render(){if(!this.hass||!this._config)return U``;const e=this._config.entity,t=this.hass.states[e];if(!t)return U`<ha-card class="empty">${this._t("generic.unknown_entity")}: ${e}</ha-card>`;if(!t.attributes.matches||0===t.attributes.matches.length)return U`
      ...
      <ha-card class="${s?"live":""}">
        ...
        ${this.showFormTrend?this._renderFormTrend(t.attributes.previous_matches,t.attributes.matches,this.myTeam||t.attributes.team_name):""}
      ...
      <div class="form-trend-section">
        ...
        <div class="form-trend-row">
          <div class="form-trend-dots">
            ${s.map((e=>U`<span class="ft-dot ${e.toLowerCase()}">${e}</span>`))}
          </div>
          <span class="form-trend-summary">${o}W ${r}G ${l}V</span>
        </div>
      </div>
    `}_renderPreviousMatches(e,t,a){const i=e&&e.length>0?e:t?t.filter((e=>"post"===e.state)).slice(-3).reverse():[];if(0===i.length)return"";const n=(a||"").toLowerCase();return U`
    ...
    `}updated(e){(e.has("showPopup")||e.has("activeMatch"))&&this.renderPopupToBody()}renderPopupToBody(){if(!this.showPopup||!this.activeMatch){const e=document.getElementById("calcio-live-team-popup");return void(e&&e.remove())}let e=document.getElementById("calcio-live-team-popup");e||(e=document.createElement("div"),e.id="calcio-live-team-popup",e.style.cssText="\n        position: fixed; inset: 0;\n        display: flex; justify-content: center; align-items: center;\n        z-index: 999999;\n        background: rgba(0,0,0,0.7);\n        backdrop-filter: blur(8px);\n        overflow: auto;\n      ",e.addEventListener("click",(t=>{t.target===e&&(this.showPopup=!1)})),document.body.appendChild(e));const t=this.activeMatch,a=e=>this._t(e),i=getComputedStyle(this),n=i.getPropertyValue("--cl-bg").trim()||"#1a1f2e",s=i.getPropertyValue("--cl-text").trim()||"#f8fafc",o=i.getPropertyValue("--cl-text-2").trim()||"#94a3b8",r=i.getPropertyValue("--cl-accent").trim()||"#6366f1",l=i.getPropertyValue("--cl-accent-2").trim()||"#ec4899",c=i.getPropertyValue("--cl-divider").trim()||"rgba(255,255,255,0.08)",d=i.getPropertyValue("--cl-surface").trim()||"rgba(255,255,255,0.04)";e.innerHTML=`\n      <div style="background:${n}; padding: 24px; border-radius: 20px; width: 90%; max-width: 560px; max-height: 85vh; overflow-y: auto; border: 1px solid ${c}; box-shadow: 0 24px 64px rgba(0,0,0,0.6); margin: auto; color: ${s}; font-family: -apple-system, BlinkMacSystemFont, 'SF Pro Display', sans-serif;">\n        <h3 style="margin:0 0 20px; font-size: 22px; font-weight: 800; letter-spacing:-0.02em; background: linear-gradient(135deg,${r},${l}); -webkit-background-clip:text; background-clip:text; -webkit-text-fill-color: transparent;">${a("popup.match_details")}</h3>\n        <div style="display:flex; justify-content:center; align-items:center; gap:18px; margin-bottom:24px;">\n          <img style="width:72px; height:72px; object-fit:contain; filter: drop-shadow(0 4px 12px rgba(0,0,0,0.4));" src="${t.home_logo}" alt="${t.home_team}" />\n          <div style="text-align:center;">\n            <div style="font-size:42px; font-weight:900; letter-spacing:-0.04em; line-height:1;">${t.home_score??"-"} <span style="opacity:0.4;">-</span> ${t.away_score??"-"}</div>\n            <div style="font-size:12px; color:${o}; margin-top:8px; font-weight:600;">${t.clock??t.status??""}</div>\n          </div>\n          <img style="width:72px; height:72px; object-fit:contain; filter: drop-shadow(0 4px 12px rgba(0,0,0,0.4));" src="${t.away_logo}" alt="${t.away_team}" />\n        </div>\n        <div style="display:grid; grid-template-columns:1fr 1fr; gap:14px; margin-bottom:18px;">\n          <div style="background:${d}; padding:14px; border-radius:14px;">\n            <div style="font-size:10px; text-transform:uppercase; letter-spacing:0.1em; color:${o}; font-weight:700; margin-bottom:6px;">${t.home_team}</div>\n            <div style="font-size:13px;"><span style="color:${o};">${a("team.possession")}:</span> <strong>${t.home_statistics?.possessionPct??"—"}%</strong></div>\n            <div style="font-size:13px;"><span style="color:${o};">${a("team.shots")}:</span> <strong>${t.home_statistics?.totalShots??"—"}</strong></div>\n            <div style="font-size:13px;"><span style="color:${o};">${a("team.on_target")}:</span> <strong>${t.home_statistics?.shotsOnTarget??"—"}</strong></div>\n            <div style="font-size:13px;"><span style="color:${o};">${a("team.fouls")}:</span> <strong>${t.home_statistics?.foulsCommitted??"—"}</strong></div>\n          </div>\n          <div style="background:${d}; padding:14px; border-radius:14px;">\n            <div style="font-size:10px; text-transform:uppercase; letter-spacing:0.1em; color:${o}; font-weight:700; margin-bottom:6px;">${t.away_team}</div>\n            <div style="font-size:13px;"><span style="color:${o};">${a("team.possession")}:</span> <strong>${t.away_statistics?.possessionPct??"—"}%</strong></div>\n            <div style="font-size:13px;"><span style="color:${o};">${a("team.shots")}:</span> <strong>${t.away_statistics?.totalShots??"—"}</strong></div>\n            <div style="font-size:13px;"><span style="color:${o};">${a("team.on_target")}:</span> <strong>${t.away_statistics?.shotsOnTarget??"—"}</strong></div>\n            <div style="font-size:13px;"><span style="color:${o};">${a("team.fouls")}:</span> <strong>${t.away_statistics?.foulsCommitted??"—"}</strong></div>\n          </div>\n        </div>\n        <div id="team-events-container"></div>\n        <button id="popup-close-btn" style="background:linear-gradient(135deg,${r},${l}); color:white; padding:12px 20px; border:none; border-radius:12px; cursor:pointer; margin-top:20px; font-weight:800; width:100%; font-size:14px;">${a("generic.close")}</button>\n      </div>\n    `;const p=e.querySelector("#popup-close-btn");p&&p.addEventListener("click",(()=>{this.showPopup=!1}));const h=e.querySelector("#team-events-container"),{goals:g,yellowCards:u,redCards:m}=this.separateEvents(t.match_details||[]),f=(e,t,a)=>t.length?`<div style="margin-bottom:14px; padding:14px; background:${a.bg}; border-left:3px solid ${a.border}; border-radius:10px;">\n        <h5 style="margin:0 0 8px; font-size:12px; text-transform:uppercase; letter-spacing:0.08em; color:${a.border}; font-weight:800;">${e}</h5>\n        <ul style="margin:0; padding-left:18px; font-size:13px; color:#cbd5e1;">${t.map((e=>`<li style="margin:4px 0;">${e}</li>`)).join("")}</ul>\n      </div>`:"";let v="";v+=f(a("event.goal"),g,{bg:"rgba(99,102,241,0.1)",border:"#6366f1"}),v+=f(a("event.yellow_card"),u,{bg:"rgba(245,158,11,0.1)",border:"#f59e0b"}),v+=f(a("event.red_card"),m,{bg:"rgba(239,68,68,0.1)",border:"#ef4444"});const b=t.lineup_home||[],_=t.lineup_away||[];if(b.length||_.length){const e=t.formation_home||"",i=t.formation_away||"",n=(e,t,a)=>{const i=(e||[]).filter((e=>e.starter));return i.length?`<div style="margin-bottom:8px;">\n          <div style="display:flex; justify-content:space-between; align-items:baseline; margin-bottom:6px;">\n            <span style="font-size:12px; font-weight:800; color:#fff;">${a}</span>\n            ${t?`<span style="font-size:10px; font-weight:700; color:#6366f1; letter-spacing:0.1em;">${t}</span>`:""}\n          </div>\n          <div style="font-size:12px; color:#cbd5e1; line-height:1.7;">\n            ${i.map((e=>`<span style="display:inline-block; padding:2px 8px; background:rgba(255,255,255,0.05); border-radius:6px; margin:2px;">${e.jersey?`<strong style="color:#fbbf24;">${e.jersey}</strong> `:""}${e.short_name||e.name}</span>`)).join("")}\n          </div>\n        </div>`:""};v+=`<div style="margin-bottom:14px; padding:14px; background:rgba(16,185,129,0.08); border-left:3px solid #10b981; border-radius:10px;">\n        <h5 style="margin:0 0 10px; font-size:12px; text-transform:uppercase; letter-spacing:0.08em; color:#10b981; font-weight:800;">${a("popup.lineups")}</h5>\n        ${n(b,e,t.home_team)}\n        ${n(_,i,t.away_team)}\n      </div>`}const x=t.key_events||[];if(x.length){const e=e=>{const t=(e.type||"").toLowerCase(),a=(e.type_text||"").toLowerCase();return"goal"===t||e.scoring_play?"⚽":a.includes("yellow")?"🟨":a.includes("red")?"🟥":"substitution"===t?"🔄":a.includes("halftime")?"⏸":a.includes("kickoff")?"▶":a.includes("end")?"🏁":"·"};v+=`<div style="margin-bottom:14px; padding:14px; background:rgba(251,191,36,0.08); border-left:3px solid #fbbf24; border-radius:10px;">\n        <h5 style="margin:0 0 10px; font-size:12px; text-transform:uppercase; letter-spacing:0.08em; color:#fbbf24; font-weight:800;">${a("popup.timeline")}</h5>\n        <ul style="margin:0; padding:0; list-style:none;">\n          ${x.map((t=>`<li style="display:grid; grid-template-columns:36px 24px 1fr; gap:8px; align-items:start; padding:5px 0; border-bottom:1px solid rgba(255,255,255,0.04); font-size:12px; color:#cbd5e1;">\n            <span style="text-align:right; font-weight:700; color:#94a3b8; font-variant-numeric:tabular-nums;">${t.clock||""}</span>\n            <span style="text-align:center;">${e(t)}</span>\n            <span><strong style="color:#fff;">${(t.athletes||[]).filter(Boolean).join(", ")||t.type_text||""}</strong>${t.team?`<br><span style="color:#94a3b8; font-size:11px;">${t.team}</span>`:""}</span>\n          </li>`)).join("")}\n        </ul>\n      </div>`}const y=t.head_to_head||[];y.length&&(v+=`<div style="margin-bottom:14px; padding:14px; background:rgba(var(--cl-accent-rgb),0.08); border-left:3px solid var(--cl-accent); border-radius:10px;">\n        <h5 style="margin:0 0 10px; font-size:12px; text-transform:uppercase; letter-spacing:0.08em; color:#6366f1; font-weight:800;">${a("popup.h2h")} (${y.length})</h5>\n        <ul style="margin:0; padding:0; list-style:none;">\n          ${y.slice(0,8).map((e=>{const t=e.date?new Date(e.date).toLocaleDateString(de(this.hass,this._config)):"";return`<li style="display:flex; justify-content:space-between; padding:5px 0; border-bottom:1px solid rgba(255,255,255,0.04); font-size:12px; color:#cbd5e1;">\n              <span>${e.home_team} <strong>${e.home_score??"-"}</strong> - <strong>${e.away_score??"-"}</strong> ${e.away_team}</span>\n              <span style="color:#94a3b8;">${t}</span>\n            </li>`})).join("")}\n        </ul>\n      </div>`),h.innerHTML=v||`<p style="text-align:center; color:#94a3b8; font-size:13px;">${a("popup.no_events")}</p>`}static get styles(){return[he,s`
      :host {
        --cl-accent: #6366f1;
        --cl-accent-2: #ec4899;
        --cl-live: #ef4444;
